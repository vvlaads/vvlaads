...
public class CommandManager implements Serializable {
    ...
    public void addAllCommands() {
        ...
        addCommand(new ClearCommand(getCollectionManager(), this));
        addCommand(new InsertCommand(getCollectionManager(), this));
        addCommand(new UpdateCommand(getCollectionManager(), this));
        addCommand(new RemoveKeyCommand(getCollectionManager(), this));
        addCommand(new ExecuteScriptCommand(getCollectionManager(), getDatabaseManager()));
        ...
        addCommand(new RemoveLowerKeyCommand(getCollectionManager(), this));
    ...
    /**
     * Конструктор задает менеджер для работы с коллекцией и менеджер для работы с базой данных.
     *
     * @param collectionManager менеджер для работы с коллекцией
     * @param databaseManager   менеджер для работы с базой данных
     */
