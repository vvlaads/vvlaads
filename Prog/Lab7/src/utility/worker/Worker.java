...
public class Worker implements Comparable<Worker>, Serializable {
     ...
     */
    @JsonIgnore
    private LocalDateTime creationDate = LocalDateTime.now(); //Поле не может быть null, Значение этого поля должно
     ...
     * @param name         имя работника
     * @param coordinates  расположение работника
     * @param creationDate дата создания работника
     * @param salary       зарплата работника
     * @param position     должность работника
     * @param status       статус работника
     * @param organization организация работника
     */
    public Worker(Long id, String name, Coordinates coordinates, LocalDateTime creationDate, Long salary, Position position, Status status,
                  Organization organization) {
        setId(id);
        setName(name);
        setCoordinates(coordinates);
     ...
     *
     * @param localDateTime дата создания работника
     */
