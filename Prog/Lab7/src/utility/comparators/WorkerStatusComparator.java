...
/**
 * Класс для сортировки работников по их статусу.
 */
public class WorkerStatusComparator implements Comparator<Worker> {
    /**
    ...
    public int compare(Worker worker1, Worker worker2) {
        return worker1.getStatus().compareTo(worker2.getStatus());
    }
}
